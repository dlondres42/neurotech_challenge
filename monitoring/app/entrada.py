...
class Entrada(BaseModel):
    ...
    # If user inputs an Entrada with an undefined field, it throws ValueError
    class Config:
        extra = "forbid"
    ...
    def validate_date(cls, v):
        try:
            ...
            raise ValueError('Invalid date format. Use ISO 8601 format: yyyy-mm-ddThh:mm:ss.ssssss')
        return v
